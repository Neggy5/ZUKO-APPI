...
/**
 * DarkNaija — ZUKO v1 endpoint
 * GET /v1/download/darknaija?q=search
 * GET /v1/download/darknaija?url=https://...
 */
...
module.exports = {
  name: 'DarkNaija',
  method: 'GET',
  path: '/v1/download/darknaija',
  category: 'Download',
  description: 'Search or download from DarkNaija',

  async execute({ query, ctx }) {
    const siteKey = 'darknaija';
