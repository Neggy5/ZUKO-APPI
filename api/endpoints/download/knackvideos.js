...
/**
 * KnackVideos
 * Search: GET /download/knackvideos?q=query
 * Download: GET /download/knackvideos?url=https://...
 */

const { scrapeList, scrapePost, SITES } = require('../../lib/naijaSites');

module.exports = {
  path: '/download/knackvideos',
  method: 'GET',
  description: 'KnackVideos search + direct MP4 extract',
  query: {
