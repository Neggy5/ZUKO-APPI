...
/**
 * NaijaXX
 * Search: GET /download/naijaxx?q=query
 * Download: GET /download/naijaxx?url=https://...
 */

const { scrapeList, scrapePost, SITES } = require('../../lib/naijaSites');

module.exports = {
  path: '/download/naijaxx',
  method: 'GET',
  description: 'NaijaXX search + direct MP4 extract',
  query: {
