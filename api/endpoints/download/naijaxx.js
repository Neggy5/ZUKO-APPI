...
/**
 * NaijaXX — ZUKO v1 endpoint
 * GET /v1/download/naijaxx?q=search
 * GET /v1/download/naijaxx?url=https://...
 */
...
module.exports = {
  name: 'NaijaXX',
  method: 'GET',
  path: '/v1/download/naijaxx',
  category: 'Download',
  description: 'Search or download from NaijaXX',
